...
const perks = [
...

  {
    ...
    Icon: Leaf,
    description:
      "We've plaedged 1% of sales to the preservation and restoration of the natural environment.",
  },
];
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl ">
            High Quality <span className="text-red-600">Products</span>
          </h1>
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to BrandName. Every product on our platform is verified by
